...
typedef struct fileset {
	...
	ptfileset_t 	fs_perthread[MAX_THREAD];
} fileset_t;
...
int fileset_openfile_perthread(fb_fdesc_t *fd, fileset_t *fileset,
    filesetentry_t *entry, int flag, int mode, int attrs, int threadid);
filesetentry_t *fileset_pick_perthread(fileset_t *fileset2, int flags, 
	int tid, int index, int threadid);
void fileset_unbusy_perthread(filesetentry_t *entry, int update_exist,
