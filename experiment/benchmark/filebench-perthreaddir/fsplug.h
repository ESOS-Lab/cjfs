...
typedef struct fsplug_func_s {
	...
	int (*fsp_fbarrier)(fb_fdesc_t *);
	int (*fsp_fdatabarrier)(fb_fdesc_t *);
...
#define FB_FBARRIER(fdesc) \
	(*fs_functions_vec->fsp_fbarrier)(fdesc)

#define FB_FDATABARRIER(fdesc) \
	(*fs_functions_vec->fsp_fdatabarrier)(fdesc)
