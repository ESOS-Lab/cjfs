...
#if defined(MON_FSYNC) || defined(MON_FBARRIER)
#define MONITORING
#define MON_MAX_INDEX 10000000
#endif
...
#ifdef MONITORING
	atomic_int shm_index;
	unsigned long long shm_ctime[MON_MAX_INDEX];
	unsigned long long shm_delay[MON_MAX_INDEX];
#endif
